...
MAX_DRONE_FAILURES = int(os.environ.get('MAX_DRONE_FAILURES', 5))
GROUNDING_TIMEOUT_MINUTES = int(os.environ.get('GROUNDING_TIMEOUT', 2))
FAILURE_AGE_MINUTES = int(os.environ.get('FAILURE_AGE_MINUTES', 60))
